...
<head>
    ...
    <style>
        ...
        .pending-requests-card {
            height: 550px;
            /* slightly taller to occupy white space */
            overflow-y: auto;
        }
                ...
                <div class="card pending-requests-card">
                    ...
                    <div class="card-body p-3">
                        ...
                        <?php
                            ...
                            ?>
                        <div
                            class="d-flex align-items-start audit-entry bg-warning bg-opacity-10 border border-warning">
                            <div class="me-2 mt-1">
                                <span
                                    class="material-symbols-outlined text-white bg-warning rounded-circle d-flex align-items-center justify-content-center">
                                    schedule
                                </span>
                            </div>
